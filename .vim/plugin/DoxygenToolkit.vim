...
function! <SID>DoxygenCommentFunc()
  ...
  mark d
	...
	"Usage Added by emux to add the usage
  exec "normal o".substitute( s:interCommentTag, "[[:blank:]]*$", "", "" )
	exec "normal o".s:interCommentTag."@par Usage:"
	exec "normal o".s:interCommentTag.""
	exec "normal o".s:interCommentTag."@code"
	exec "normal o".s:interCommentTag.g:DoxygenToolkit_templateParamTag_post
	exec "normal o".s:interCommentTag.g:DoxygenToolkit_templateParamTag_post.l:doc.name."(".g:DoxygenToolkit_templateParamTag_post.");"
	exec "normal o".s:interCommentTag."@endcode"
